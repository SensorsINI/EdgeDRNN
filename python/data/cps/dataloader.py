...
class DataLoader:
    def __init__(self, proj: Project):
        ...
        setattr(self, "train_set", mod_dataset.CPSDataset(proj, "training"))
        setattr(self, "dev_set", mod_dataset.CPSDataset(proj, "validation"))
        setattr(self, "test_set", mod_dataset.CPSDataset(proj, "testing"))

        # Create PyTorch dataloaders for train and dev set
        if proj.accelerator == "auto" or "gpu" or "mps":
